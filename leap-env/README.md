...
本 README 只保留模块内架构概览与模块索引；详细正文统一在 `../manual/`。
...
- `../manual/architecture/DoD布局引擎.md`
- `../manual/architecture/iframe多上下文.md`
- `../manual/architecture/构建系统.md`
- `../manual/architecture/运行时入口与任务执行链路.md`

## 历史迁移记录入口（非正文）

- `../manual/maintenance/2025-12-04_LeapEnv_v2架构迁移与构建系统整理.md`

说明：本目录不再保留 `SKELETON_OPTIONS.md` 等详细文档，现行说明统一以 `../manual/` 为准。
