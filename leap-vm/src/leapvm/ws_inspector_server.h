...
public:
    ...
    using OnFrontendStateCallback = std::function<void(bool connected, uint64_t generation)>;
...
private:
    ...
    OnFrontendStateCallback on_frontend_state_;
    ...
    uWS::WebSocket<false, true, void>* active_connection_ = nullptr;
